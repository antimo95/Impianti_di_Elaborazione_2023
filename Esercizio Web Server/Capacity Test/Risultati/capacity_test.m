...
[THROUGHPUT_obs_2, RESPTIME_obs_2, COV_T_2, COV_R_2] = statistic_fun ('800_1', '800_2', '800_3');
[THROUGHPUT_obs_3, RESPTIME_obs_3, COV_T_3, COV_R_3] = statistic_fun ('1000_1', '1000_2', '1000_3');
[THROUGHPUT_obs_4, RESPTIME_obs_4, COV_T_4, COV_R_4] = statistic_fun ('1300_1', '1300_2', '1300_3');
[THROUGHPUT_obs_5, RESPTIME_obs_5, COV_T_5, COV_R_5] = statistic_fun ('1500_1', '1500_2', '1500_3');
[THROUGHPUT_obs_6, RESPTIME_obs_6, COV_T_6, COV_R_6] = statistic_fun ('2000_1', '2000_2', '2000_3');
[THROUGHPUT_obs_7, RESPTIME_obs_7, COV_T_7, COV_R_7] = statistic_fun ('4000_1', '4000_2', '4000_3');
[THROUGHPUT_obs_8, RESPTIME_obs_8, COV_T_8, COV_R_8] = statistic_fun ('8000_1', '8000_2', '8000_3');
[THROUGHPUT_obs_9, RESPTIME_obs_9, COV_T_9, COV_R_9] = statistic_fun ('10000_1', '10000_2', '10000_3');
...
points = [8.3,13.3,16.6,21.6,25,33.3,66.6,133.3,166.6];
